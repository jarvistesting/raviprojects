...
import {Button, Nav, NavItem, Navbar, Glyphicon, Modal} from 'react-bootstrap';
								...
								<div className="page-header" style={{"marginTop":"20px","paddingBottom": "0px"}}  id="work_experience" name="work_experience">
									...
									<form className = "form-horizontal" name = "experience_form" id = "experience_form" method = "post">
										<Modal show={this.state.showexp} onHide={this.handleModalClose.bind(this,"showexp")}>
											...
											<Modal.Body>
												<label className = "control-label" htmlFor = "exp_organization">Organization:<sup style = {{color:'red'}}>* </sup></label>
												...
												<label className = "control-label" htmlFor = "exp_designation">Designation:<sup style = {{color:'red'}}>* </sup></label>
												...
												<label className = "control-label" htmlFor = "exp_from">Experience From (Date of Joining):<sup style = {{color:'red'}}>* </sup></label>
												...
												<label className = "control-label" htmlFor = "exp_to">To<sup style = {{color:'red'}}>* </sup></label>
												...
												<label className = "control-label" htmlFor = "exp_department">Department:<sup style = {{color:'red'}}>* </sup></label>
								...
								<div className="page-header" style={{"marginTop":"20px","paddingBottom": "0px"}} id="project_detail" name="project_detail">
									...
									<form className = "form-horizontal" name = "project_form" id = "project_form" method = "post">
										<Modal show={this.state.showproject} onHide={this.handleModalClose.bind(this,"showproject")}>
											...
											<Modal.Body>
												<label className = "control-label" htmlFor = "project_title">Project Title:<sup style = {{color:'red'}}>* </sup></label>
												...
												<label className = "control-label" htmlFor = "project_description">Description:<sup style = {{color:'red'}}>* </sup></label>
												...
												<label className = "control-label" htmlFor = "project_from">Project Start From:<sup style = {{color:'red'}}>* </sup></label>
												...
												<label className = "control-label" htmlFor = "project_to">Project End At<sup style = {{color:'red'}}>* </sup></label>
												...
												<label className = "control-label" htmlFor = "project_role">Role:<sup style = {{color:'red'}}>* </sup></label>
												...
												<label className = "control-label" htmlFor = "project_team">Team Size:<sup style = {{color:'red'}}>* </sup></label>
								...
								<div className="page-header" style={{"marginTop":"20px","paddingBottom": "0px"}} name="technical_skill" id="technical_skill">
									...
									<form className = "form-horizontal" name = "skill_form" id = "skill_form">
										<Modal show={this.state.showskill} onHide={this.handleModalClose.bind(this,"showskill")}>
											...
											<Modal.Body>
												<label className = "control-label" htmlFor = "skill_name">Skill:<sup style = {{color:'red'}}>* </sup></label>
												...
												<label className = "control-label" htmlFor = "exp_year">Experience Year:<sup style = {{color:'red'}}>* </sup></label>
												...
												<label className = "control-label" htmlFor = "exp_month">Experience Month:<sup style = {{color:'red'}}>* </sup></label>
